...
public class RawEnumTableTest {
  ...
  public void playerTest() {
    ...
    RawEnumTable table = new RawEnumTable<WallBlockType>(WallBlockType.EMPTY, width, length);
    ...
    Assert.assertTrue("Test.(y + height) should be 0.5 above floor.y", test.getY() + test.getHeight() == floor.getY() - 0.5f);
    ...
    test.setY(floor.getY() - Sizes.BLOCK + 0.5f);
    Assert.assertTrue("Test.(y + height) should be 0.5 below floor.y", test.getY() + test.getHeight() == floor.getY() + 0.5f);
    ...
    Assert.assertTrue("Test.(y + height) should be 1 below floor.y", test.getY() + test.getHeight() == floor.getY() + 1f);
